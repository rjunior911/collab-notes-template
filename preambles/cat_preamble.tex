...
\newcommand{\icat}[1]{\mathbb{#1}}%TODO decide on higher category convention
\newcommand{\ifun}[1]{\mathbb{#1}}%TODO decide on higher category convention
%\newcommand{\Cat}{\cat{CAT}} %TODO this was changed to fit convention 1, but may cause errors
%Internal Categories
...
\newcommand{\BB}[1]{\cat{B}\mathbb{#1}} %Classifying spaces
